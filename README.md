...
### 3. **Single Region Base Lab Environment for Azure** - **Note: Now updated - see [Single Region Azure Base Lab V2](https://github.com/jakewalsh90/Terraform-Azure#14-single-region-base-lab-environment-for-azure---v2)**
