...
Invoke-WebRequest -Uri "https://jwukslabstorage01.blob.core.windows.net/baselab/baselab_DomainSetup.ps1" -OutFile "C:\BaselabSetup\baselab_DomainSetup.ps1"
Invoke-WebRequest -Uri "https://jwukslabstorage01.blob.core.windows.net/baselab/baselab_LabStructure.ps1" -OutFile "C:\BaselabSetup\baselab_LabStructure.ps1"
